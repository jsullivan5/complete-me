...
describe('The Trie', () => {
  ...
  it('should instatiate a trie', () => {    expect(trie).to.be.instanceOf(Trie)
  })
  ...
  it('should count number of words in the tree', () => {
    ...
    describe('the tree populated with the dictionary', function() {
      ...
      it('should suggest words based on the dictionary', () => {
        ...
        trie.count()
        expect(trie.wordCount).to.be.above(200000)
        expect(trie.suggest('hell')).to.deep.equal([ 'helladian',
        'helladic',
        'helladotherium',
        'hellandite',
        'hellanodic',
    ...
    describe('select function', () => {
      it('should traverse the tree for the length of the word and incremenet the frequency', () => {
 ...
 560- 
      it('should order suggestions by frequency', () => {
        trie.select('hellbox')
        expect(trie.suggest('hell')).to.deep.equal([ 'hellbox',
        'helladian',
        'helladic',
        'helladotherium',
        'hellandite',
